...
public:
    App(): _window(sf::RenderWindow(sf::VideoMode(1100, 1500), "Doctor")), _next(100, 900, 150, 50, "next"), _update(800, 900, 150, 50, "update"), _inputHS(30, 550, 500, 150, "HealthScript"), _inputDrugs(750, 500, 200, 30){
